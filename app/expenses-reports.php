...
<?php if(is_authorized($account_type, "expenses-report", "", "") === "allowed"){ ?>
    <title>Expenses Reports | <?php echo get_company_data("company_name");?></title>
    <body>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col">
                                <h3 class="page-title">Expenses Reports</h3>
                                <ul class="breadcrumb">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="datatable- table table-hover table-stripped mb-0" style="border:2px solid #eee;">
                                            ...
                                            <tbody>
                                                <?php echo get_expenses_reports();?>
                                            </tbody>
                                        </table>
                                    </div>

                                    <div style="margin-top:20px;" class="pull-right"> <a href="./print-expenses-reports?from=<?php echo $from_date;?>&to=<?php echo $to_date;?>" target="_blank" class="btn btn-danger"><span class="fa fa-print"></span> Print </a> </div>
