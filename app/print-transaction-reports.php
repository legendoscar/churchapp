...
<head>
    ...
    <title>TRANSACTION REPORTS from <?php echo $from_date;?> to <?php echo $to_date;?></title>

</head>

    <?php require "./includes/update_activity.php";?>
    <?php if(is_authorized($account_type, "print-transaction-report", "", "") === "allowed"){ ?>
