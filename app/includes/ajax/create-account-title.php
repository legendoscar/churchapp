<?php session_start();
    if($_SERVER['REQUEST_METHOD'] === "POST") {
        ...
        if(is_authorized($account_type, "create-account-title", "", "") == "allowed"){ // ENSURE USER HAS ADMIN PREVILLEGE 
            if( isset($_POST['item_name']) && !empty($_POST['item_name'])){
                ...
                $create = @mysqli_prepare($conn, "INSERT INTO account_titles(`name`, created_by, url_id) value(?,?,?)");
