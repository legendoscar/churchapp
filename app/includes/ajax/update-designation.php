<?php session_start();
    if($_SERVER['REQUEST_METHOD'] === "POST") {
        ...
        if(is_authorized($account_type, "edit-designation", "", "") === "allowed"){ // ENSURE USER HAS ADMIN PREVILLEGE 
            if(
                ...
                if(get_designation_data_by_id($item_id, "name") != "not_found"){//Is Existing
                    ...
                    $update = @mysqli_prepare($conn, "UPDATE designations SET `name`=?  where id=?");
