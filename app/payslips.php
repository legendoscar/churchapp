...
<?php if(is_authorized($account_type, "payslips", "", "") === "allowed") {?>
    <title>Payslips | <?php echo get_company_data("company_name");?></title>
    <body>
                        ...
                        <div class="row">
                            <div class="col">
                                <?php if(is_authorized($account_type, "create-payslip", "", "") === "allowed") {?>
                                    <a class="pull-right btn-primary btn btn-sm" href="./create-payslip"><span class="la la-file-alt"></span> New Payslip </a>
                                <?php } ?>
                                <h3 class="page-title">Payslips</h3>
                                <ul class="breadcrumb">
