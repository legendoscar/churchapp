...
<?php if(is_authorized($account_type, "payment-report", "", "") === "allowed") {?>
    <title>Payment Reports | <?php echo get_company_data("company_name");?></title>
    <body>
        ...
        <?php
            ...
            if(isset($_GET['item']) && !empty($_GET['item']) && get_payable_items_data_by_id(mysqli_real_escape_string($conn, $_GET['item']), "id") == $_GET['item']){
                $item_name = "(".get_payable_items_data_by_id(mysqli_real_escape_string($conn, $_GET['item']), "name").")";
            }
        ?>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col">
                                <h3 class="page-title">Payment Reports <?php echo $item_name;?></h3>
                                <ul class="breadcrumb">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                        if(isset($_GET['item']) && !empty($_GET['item'])) {
                                            $item = "&item=".mysqli_real_escape_string($conn, $_GET['item']);?>
                                                <div style="margin-top:20px;" class="pull-left"> <a href="./payment-reports" class="btn btn-warning"><span class="fa fa-arrow-left"></span> Go back </a> </div>
                                            <?php
                                        } else {
                                            $item = "";
                                        }
                                    ?>
                                    <div style="margin-top:20px;" class="pull-right"> <a href="./print-payment-reports?from=<?php echo $from_date;?>&to=<?php echo $to_date.$item;?>" target="_blank" class="btn btn-danger"><span class="fa fa-print"></span> Print </a> </div>
