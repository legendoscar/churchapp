...
<?php if(is_authorized($user_account_type, "payment-channels", "", "") === "allowed") {?>
    <title>POS | <?php echo get_company_data("company_name");?></title>
    <body>
                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col">
                                ...
                                <a class="pull-right btn-primary btn btn-sm" href="./settings-create-payment-channels-pos"><span class="la la-file-alt"></span> New Account </a>
