...
<?php if(is_authorized($user_account_type, "payment-channels", "", "") === "allowed") {?>
    <title>Payment Bank | <?php echo get_company_data("company_name");?></title>
    <body>
                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col">
                                ...
                                <a class="pull-right btn-primary btn btn-sm" href="./settings-create-payment-bank"><span class="la la-file-alt"></span> Add Bank </a>

                                <h3 class="page-title">Payment Bank</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="./">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Payment Bank</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="datatable table table-hover table-stripped mb-0" style="border:2px solid #eee;">
                                            ...
                                            <tbody>
                                                <?php echo get_payment_bank_list_in_table();?>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
