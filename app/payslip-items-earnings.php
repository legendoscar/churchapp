...
<title>Payslip Items - Earnings | <?php echo get_company_data("company_name");?></title>
    <body>
        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col">
                                ...
                                <h3 class="page-title">Payslip Items - Earnings (<span id='total-items'><?php echo number_format(get_payslip_items_list("count", "earnings"));?></span>)</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="./">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Payslip Items - Earnings</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <table id="item-tbl" class="datatable- table table-hover table-stripped mb-0" style="border:2px solid #eee;">
                                            ...
                                            <tbody>
                                                <?php echo get_payslip_items_list("", "earnings");?>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
                    ...
                    <?php if(strpos($_SERVER['PHP_SELF'], "payslip-items-earnings.php") == true){?>
                                ...
                                <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h5 class="modal-title" id="">New Payslip Item - Earnings</h5>
                                                ...
                                                <div class='row'>
                                                    <div class='col-md-12'>
                                                        <div class='form-group'>
                                                            ...
                                                            <input type='hidden' name='item_type' value='earnings' class='form-control'>
                                                        </div>
                                                    </div>
