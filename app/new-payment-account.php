...
<?php if(is_authorized($user_account_type, "create-payment-account", "", "") === "allowed") {?>
    <title>New Payment Accounts | <?php echo get_company_data("company_name");?></title>
    <body>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col">
                                <h3 class="page-title">New Payment Accounts</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="./">Dashboard</a></li>
                                    <li class="breadcrumb-item active">New Payment Accounts</li>
                                </ul>
                            </div>
                        </div>
                    </div>

                    <form method="POST" id="create-payment-account">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-end">
                                            ...
                                            <button type="submit" id="create-payment-account-btn" class="btn btn-primary">
